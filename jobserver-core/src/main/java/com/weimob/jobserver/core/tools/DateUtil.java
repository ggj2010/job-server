package com.weimob.jobserver.core.tools;
...
public class DateUtil {
    ...
    public static String format(Date date, String pattern) {
        try {
            ...
            log.error("DateUtil-->>format(" + date + "," + pattern + ") error", e);
            throw new RuntimeException("DateUtil-->>format(" + date + "," + pattern + ") error," + e);
        }
    }
    ...
    public static Date formatWithDefaultPattern(String dateStr) {
        try {
            ...
            log.error("DateUtil-->>formatWithDefaultPattern(" + dateStr + ") error", e);
            throw new RuntimeException("DateUtil-->>formatWithDefaultPattern(" + dateStr + ") error," + e);
        }
    }
    ...
    public static Date format(String dateStr, String pattern) {
        try {
            ...
            log.error("DateUtil-->>format(" + dateStr + "," + pattern + ") error", e);
            throw new RuntimeException("DateUtil-->>format(" + dateStr + "," + pattern + ") error," + e);
        }
    }
    ...
    public static String currentDateTime() {
        ...
        try {
            ...
            log.error("DateUtil-->>currentDateTime() error", e);
            throw new RuntimeException("DateUtil-->>currentDateTime() error," + e);
        }
    }
